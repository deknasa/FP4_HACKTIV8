...
const socialMediaData = {
    name: "nezuko",
    social_media_url: "https://www.nezuko.com/",
    user_id: user_id
}
...
describe('socialMedia post socialMedia', () => {
    it("should return 201", (done) => {
        ...
        .then(res => {
            socialMediaId = res.body.socialmedias.id
...
describe('socialmedias deleteSocialMedia', () => {
    ...
    it("should return 401 id not found", (done) => {
        request(app)
        .delete(`/socialmedias/${id_not_found}`)
        .set('authentication', `${ token }`)
        .then(res => {
            expect(res.status).toEqual(401)
            expect(typeof res.body).toEqual("object")
